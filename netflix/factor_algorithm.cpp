...
int main(int argc, char* argv[])
{
  ...
  sfa.set_training_users_dir("../netflix_data/base_lf/users");
  sfa.set_training_movies_dir("../netflix_data/base_lf/movies");
  ...
  */
  cout << "Writing user total error file: " << endl;
  sfa.write_user_total_error_file(sfa.generate_filename("user_total_error", ".txt"));
  cout << "Writing user average error file: " << endl;
  sfa.write_user_average_error_file(sfa.generate_filename("user_average_error", ".txt"));
